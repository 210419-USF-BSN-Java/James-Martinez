...
public class ReimbursementDAOImpl implements ReimbursementDAO{
	...
	public List<Reimbursement> listReimbByIdandStatus(int id, String status) { //untested
		...
		try (Connection connection = PostgresConnection.getConnection()) {
			String sql = "select r.reimb_id, r.reimb_amount, r.reimb_submitted, r.reimb_resolved, r.reimb_desc,\r\n"
			...
			while(resultSet.next()) {
				...
				reimb.setTimeSubmitted(resultSet.getTimestamp("reimb_submitted"));
				reimb.setTimeResolved(resultSet.getTimestamp("reimb_resolved"));
				...
				reimb.setResolverIdAndName("Resolved by: "+ resultSet.getString("first_name") +" "+ resultSet.getString("last_name"));
				reimbList.add(reimb);
			}
		} catch (ClassNotFoundException | SQLException e) {
			log.debug(e);
